...
def ParseGraph(file):
    ...
    for line in file_object.readlines():
        capacity.append([int(i) for i in line.split(',') if i!= '' and i!='\n'])
...
#         print (line)
#     print (neighbors)
#     fmap = [[0 for i in range(len(capacity))]for j in range(len(capacity))]
#     for i in range(len(capacity)):
#         for j in range(len(capacity)):
#             flow, flows = EdmondsKarp(capacity, neighbors, i,j)
#             fmap [i][j] = flow
#             print([i,j])
